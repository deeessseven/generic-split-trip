...
export class GameScene extends Phaser.Scene {
  ...
  create() {
    ...
    // Panel labels — nudged W/10 toward the horizontal center (left moves right, right moves left)
    this.add.text(6 + W / 10, 6, `${GT.labelTopView}\n${GT.labelTopHint}`, {
      fontSize: '11px', fontFamily: 'Arial', color: '#eceff1',
      alpha: 0.7,
    }).setDepth(6);
    this.add.text(W - 6 - W / 10, 6, `${GT.labelSideView}\n${GT.labelSideHint}`, {
