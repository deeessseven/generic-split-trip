...
- Everything → **No**. Expected result: **Everyone**.

## Data safety form — answers
- **Does your app collect or share any user data?** → **No.**
- On-device only (settings, best scores, custom images) → **no data collected, no data shared**.
- Encrypted in transit: N/A. · Account deletion: N/A.

## Distribution
- Countries: your choice. · Contains ads: **No**.
